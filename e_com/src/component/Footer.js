...
<footer className="text-white bg-gray-400 p-2">
    ...
    <div className="px-4 py-6 flex justify-around bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        ...
        <div className="flex justify-center items-center sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
